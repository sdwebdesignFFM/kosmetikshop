...
class Customer extends Authenticatable implements CustomerContract
{
     ...
     * @var array
     */
    protected $appends = ['image_url', 'business_document_url'];
    ...
    /**
     * Get the admin who approved this customer.
     *
     * @return \Illuminate\Database\Eloquent\Relations\BelongsTo
     */
    public function approver()
    {
        return $this->belongsTo(\Webkul\User\Models\Admin::class, 'approved_by');
    }
    ...
    /**
     * Approve customer for B2B access.
     */
    ...
    /**
     * Reject customer B2B application.
     */
    public function reject(int $adminId): bool
    {
        return $this->update([
