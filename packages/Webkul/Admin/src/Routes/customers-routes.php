...
Route::prefix('customers')->group(function () {
     ...
     * B2B Approval routes.
     */
    Route::controller(\Webkul\Admin\Http\Controllers\B2B\B2BApprovalController::class)->prefix('b2b/approvals')->group(function () {
        Route::get('', 'index')->name('admin.customers.b2b.approvals.index');
        Route::post('{customerId}/approve', 'approve')->name('admin.customers.b2b.approvals.approve');
        Route::post('{customerId}/reject', 'reject')->name('admin.customers.b2b.approvals.reject');
        Route::post('{customerId}/reset', 'reset')->name('admin.customers.b2b.approvals.reset');
        Route::get('{customerId}/download', 'downloadDocument')->name('admin.customers.b2b.approvals.download');
        Route::delete('{customerId}/delete-document', 'deleteDocument')->name('admin.customers.b2b.approvals.delete-document');
    });
});
