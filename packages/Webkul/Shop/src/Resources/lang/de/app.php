...
return [
    'customers' => [
        ...
        'signup-form' => [
            ...
            'bagisto'                     => 'Bagisto',
            'business-document'           => 'Gewerbeschein / Berufsnachweis',
            'business-document-info'      => 'Laden Sie Ihren Gewerbeschein oder Berufsnachweis als Kosmetikerin hoch (PDF, JPG, PNG, max. 5MB)',
            'button-title'                => 'Registrieren',
            'click-here'                  => 'Hier klicken',
            'confirm-pass'                => 'Passwort bestätigen',
            'email'                       => 'E-Mail',
            'first-name'                  => 'Vorname',
            'footer'                      => '© Copyright 2025 - :current_year, sdWebdesign. Alle Rechte vorbehalten.',
            'form-signup-text'            => 'Wenn Sie Partner werden möchten, freuen wir uns, Sie als Mitglied begrüßen zu dürfen.',
            'last-name'                   => 'Nachname',
            'page-title'                  => 'Partner werden',
            'phone'                       => 'Telefonnummer',
            'password'                    => 'Passwort',
            'sign-in-button'              => 'Anmelden',
