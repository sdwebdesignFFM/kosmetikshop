...
<v-carousel :images="{{ json_encode($options['images'] ?? []) }}">
    <div class="overflow-hidden">
        <div class="shimmer h-64 md:h-80 lg:h-96 w-screen"></div>
    </div>
</v-carousel>
            ...
            >
                ...
                >
                    <x-shop::media.images.lazy
                        class="h-64 md:h-80 lg:h-96 w-full object-cover select-none transition-transform duration-300 ease-in-out"
                        ::lazy="false"
                        ::src="image.image"
