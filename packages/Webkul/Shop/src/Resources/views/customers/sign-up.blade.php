		...
		<div class="m-auto w-full max-w-[870px] rounded-xl border border-zinc-200 p-16 px-[90px] max-md:px-8 max-md:py-8 max-sm:border-none max-sm:p-0">
            ...
            <div class="mt-14 rounded max-sm:mt-8">
                <x-shop::form 
                    ...
                    <!-- Business Document -->
                    <div class="mb-6">
                        <label class="block mb-2 text-base font-semibold text-zinc-900 required">
                            @lang('shop::app.customers.signup-form.business-document')
                        </label>
                        ...
                        <input
                            ...
                            class="w-full px-6 py-4 max-md:py-3 max-sm:py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                            accept=".pdf,.jpg,.jpeg,.png"
                            required
                            aria-required="true"
                            aria-label="@lang('shop::app.customers.signup-form.business-document')"
                        />
                        ...
                        <p class="mt-1 text-xs text-zinc-500">
                            @lang('shop::app.customers.signup-form.business-document-info')
                        </p>
                    </div>

                    {!! view_render_event('bagisto.shop.customers.signup_form.business_document.after') !!}
