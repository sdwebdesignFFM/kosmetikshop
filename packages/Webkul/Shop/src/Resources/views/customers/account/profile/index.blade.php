<x-shop::layouts.account>
    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <!-- B2B Status Information -->
        @b2bIsPending
            <div class="mt-8 bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-lg">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <span class="icon-clock text-yellow-400 text-xl"></span>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm text-yellow-800 font-medium">
                            Ihr B2B-Antrag wird noch bearbeitet
                        </p>
                        <p class="mt-1 text-sm text-yellow-700">
                            Die Prüfung Ihres Gewerbescheins dauert in der Regel nicht mehr als 24 Stunden. 
                            Danach können Sie Preise sehen und Produkte bestellen.
                        </p>
                        @if(auth()->guard('customer')->user()->business_document_url)
                            <p class="mt-2 text-xs text-yellow-600">
                                <a href="{{ auth()->guard('customer')->user()->business_document_url }}" target="_blank" class="underline">
        ...
        @if(auth()->guard('customer')->user()->isRejected())
            <div class="mt-8 bg-red-50 border-l-4 border-red-400 p-4 rounded-lg">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <span class="icon-exclamation text-red-400 text-xl"></span>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm text-red-800 font-medium">
                            Ihr B2B-Antrag wurde abgelehnt
                        </p>
                        <p class="mt-1 text-sm text-red-700">
                            Bei Fragen wenden Sie sich an unseren Kundenservice unter info@kosmetikerin.org
                        </p>
                    </div>
                </div>
            </div>
        ...
        @b2bIsApproved
            <div class="mt-8 bg-green-50 border-l-4 border-green-400 p-4 rounded-lg">
                <div class="flex">
                    <div class="flex-shrink-0">
                        <span class="icon-check text-green-400 text-xl"></span>
                    </div>
                    <div class="ml-3">
                        <p class="text-sm text-green-800 font-medium">
                            Ihr B2B-Zugang ist aktiv
                        </p>
                        <p class="mt-1 text-sm text-green-700">
                            Sie können jetzt alle Preise sehen und Produkte bestellen.
                        </p>
                    </div>
                </div>
            </div>
